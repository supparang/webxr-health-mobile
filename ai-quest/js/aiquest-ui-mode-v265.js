/*
  CSAI2102 AI Quest
  PATCH v2.6.5 Student Mode Session 2 Feedback
  ------------------------------------------------------------
...
(function(){
  ...
  const VERSION = 'v2.6.5-student-mode-session2-feedback';
  ...
  function ensureStudentStartPanel(){
    ...
    panel.innerHTML = `
      ...
      <p>
        <b>Session 1: AI Awakening</b> และ <b>Session 2: Agent Builder</b>
        ส่งผลเข้า Google Sheets หลังกรอก Reflection ครบ
      </p>
      ...
      <div class="studentStepGrid">
        ...
        <div class="studentStep">
          <b>Session 2</b><br>
          Intelligent Agent / PEAS / Environment / Rational Agent
        </div>
        <div class="studentStep">
          <b>ส่งผล</b><br>
      ...
      <div class="row studentStartActions" style="margin-top:16px">
        ...
        <button class="btn good" id="studentStartSession2">เริ่ม Session 2</button>
  ...
  function sessionInfo(state, id){
    ...
    let cls = 'warn';
    let next = id === 'm1' ? 'เริ่มเล่น Session 1' : 'เริ่มเล่น Session 2 หลังผ่าน Session 1';

    if(bestScore != null){
      if(mastered){
        status = 'Mastery';
        cls = 'good';
        next = id === 'm1' ? 'พร้อมไป Session 2 / Challenge' : 'พร้อมต่อยอด Session 3';
  ...
  function refreshStudentProgressPanel(showToastFlag){
    ...
    if(b1.bestScore != null) overall = b1.mastered ? 'Rookie Boss Mastery แล้ว พร้อมต่อยอดกลุ่ม Search' : 'เล่น Rookie Boss แล้ว ดู feedback และเล่นซ้ำเพื่อ Mastery ได้';
    ...
    if(showToastFlag && window.showToast){
      showToast('อัปเดตสถานะ Session 1 / Session 2 แล้ว');
    }
  }
