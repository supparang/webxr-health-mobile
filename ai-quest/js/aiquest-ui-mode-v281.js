/*
  CSAI2102 AI Quest
  PATCH v2.8.1 Student Mode Session 2 Feedback
  ------------------------------------------------------------
...
(function(){
  ...
  const VERSION = 'v2.8.1-student-mode-s4-ui-consistency';
  ...
  function ensureStudentStartPanel(){
    ...
    panel.innerHTML = `
      ...
      <p>
        <b>Session 1–4</b> เปิดตาม progress: AI Awakening → Agent Builder → Boss B1 → Search Maze → Route Cost
      </p>
