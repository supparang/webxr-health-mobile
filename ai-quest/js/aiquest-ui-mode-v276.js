/*
  CSAI2102 AI Quest
  PATCH v2.7.6 Student Mode Session 2 Feedback
  ------------------------------------------------------------
...
(function(){
  ...
  const VERSION = 'v2.7.6-student-mode-before-s4-consistency';
        ...
        next = id === 'm1'
          ...
          : id === 'm2'
            ...
            : id === 'b1'
              ...
              : id === 'm3'
                ? 'พร้อมไป Session 4 เมื่อเปิด หรือเล่นซ้ำเพื่อความแม่นยำ'
  ...
  function refreshStudentProgressPanel(showToastFlag){
    ...
    if(s3.bestScore != null){
      overall = s3.mastered
        ? 'ผ่าน Session 3 แบบ Mastery แล้ว พร้อมต่อยอด Session 4 เมื่อเปิด'
        : s3.bestScore >= 70
          ? 'ผ่าน Session 3 แล้ว สามารถเล่นซ้ำเพื่อ Mastery หรือรอ Session 4 ได้'
    ...
    if(showToastFlag && window.showToast){
      showToast('อัปเดตสถานะ Session 1 / Session 2 / Boss B1 / Session 3 แล้ว');
    }
  }
