/* CSAI2102 S2 Bootstrap v6.9.9 — no polling decorators */
(()=>{'use strict';
  if(window.__AQ_S2_BOOTSTRAP_699__)return;
  window.__AQ_S2_BOOTSTRAP_699__=true;
  const queue=[
  ...
  async function load(name,src,check){
    ...
    const id='aqS2Bootstrap699_'+name;let node=document.getElementById(id);
