...
(function(){
  ...
  const VERSION = 'v3.2.7-phase1-ready-cleanup';
  ...
  function addTeacherChecklist(){
    ...
    const old=document.getElementById('phase1TeacherChecklistV327');
    if(old) old.remove();
    ...
    box.id='phase1TeacherChecklistV327';
  ...
  if(!window.__AIQUEST_PHASE1_READY_OBSERVER_V327){
    window.__AIQUEST_PHASE1_READY_OBSERVER_V327 = new MutationObserver(() => {
      clearTimeout(window.__AIQUEST_PHASE1_READY_TIMER_V327);
      window.__AIQUEST_PHASE1_READY_TIMER_V327 = setTimeout(refresh,180);
    });
    window.__AIQUEST_PHASE1_READY_OBSERVER_V327.observe(document.documentElement, {childList:true, subtree:true, characterData:true});
  }
