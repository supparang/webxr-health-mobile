/*
  CSAI2102 AI Quest
  PATCH v2.3.6 Teacher Console Polish
  ------------------------------------------------------------
...
(function(){
  ...
  const VERSION = 'v2.3.6-teacher-console-polish';
  ...
  function buildCleanLink(mode){
    ...
    if(mode === 'teacher'){
      ...
      url.searchParams.set('v', '20260610-teacher236');
    }else{
      url.searchParams.set('v', '20260610-student236');
    }
