...
(()=>{
  'use strict';
  const VERSION='v2.2-s2-boss-feedback-s4-s6-summary-bridge';
  ...
  function start(){setTimeout(boot,100);load('aqS4ThaiUI','./js/aiquest-s4-ui-thai-v1.js?v=20260703-s4thai1');load('aqS6SummaryThai','./js/aiquest-s6-summary-thai-v1.js?v=20260703-s6summary1');}
