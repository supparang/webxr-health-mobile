...
(function(){
  ...
  const VERSION = 'v3.4.8-teacher-dashboard-restore';
  ...
  function addFinalReadinessCard(){
    ...
    card.innerHTML = `
      <h3 style="margin:0 0 8px">Teacher bySession Attempt Mapper</h3>
  ...
  function refresh(){
    normalizeRiskLabels();
    /* v3.4.8 safe restore: no extra teaching decision card */
    /* v3.4.8: final card handled by teacher-dashboard-clean */
    markS6Phase2();
