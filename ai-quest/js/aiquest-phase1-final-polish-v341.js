...
(function(){
  ...
  const VERSION = 'v3.4.1-teacher-dashboard-restore';
  ...
  function addFinalReadinessCard(){
    ...
    card.innerHTML = `
      <h3 style="margin:0 0 8px">Teacher Only Page</h3>
  ...
  function refresh(){
    normalizeRiskLabels();
    /* v3.4.1 safe restore: no extra teaching decision card */
    /* v3.4.1: final card handled by teacher-dashboard-clean */
    markS6Phase2();
