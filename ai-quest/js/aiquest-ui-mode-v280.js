/*
  CSAI2102 AI Quest
  PATCH v2.8.0 Student Mode Session 2 Feedback
  ------------------------------------------------------------
...
(function(){
  ...
  const VERSION = 'v2.8.0-student-mode-session4-route-cost';
          ...
          : id === 'm2'
            ...
            : id === 'b1'
              ...
              : id === 'm3'
                ...
                : id === 'm4'
                  ? 'พร้อมไป Session 5 A* เมื่อเปิด หรือเล่นซ้ำเพื่อ Mastery'
  ...
  function refreshStudentProgressPanel(showToastFlag){
    ...
    if(s4.bestScore != null){
      overall = s4.mastered
        ? 'ผ่าน Session 4 แบบ Mastery แล้ว พร้อมต่อยอด Session 5 A* เมื่อเปิด'
        : s4.bestScore >= 70
          ? 'ผ่าน Session 4 แล้ว สามารถเล่นซ้ำเพื่อ Mastery หรือรอ Session 5 ได้'
