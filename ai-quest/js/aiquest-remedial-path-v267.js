...
(function(){
  ...
  const VERSION = 'v2.6.7-constructed-review-ux';
  const STATE_KEY = 'CSAI2102_AIQUEST_PRES3_CONSTRUCTED_V267';
  const RECENT_KEY = 'CSAI2102_AIQUEST_PRES3_RECENT_FAMILIES_V267';
