/*
  CSAI2102 AI Quest
  PATCH v2.5.3 Student Mode Session 2 Feedback
  ------------------------------------------------------------
...
(function(){
  ...
  const VERSION = 'v2.5.3-student-mode-session2-feedback';
  ...
  function refreshStudentProgressPanel(showToastFlag){
    ...
    if(s2.bestScore != null) overall = s2.mastered ? 'Session 2 Mastery แล้ว พร้อมต่อยอด Session 3' : 'เล่น Session 2 แล้ว ดู feedback และเล่นซ้ำเพื่อ Mastery ได้';
