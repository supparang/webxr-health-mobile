...
(function(){
  ...
  const VERSION = 'v3.4.5-teacher-dashboard-restore';
  ...
  function addFinalReadinessCard(){
    ...
    card.innerHTML = `
      <h3 style="margin:0 0 8px">Teacher Student Detail Clean View</h3>
  ...
  function refresh(){
    normalizeRiskLabels();
    /* v3.4.5 safe restore: no extra teaching decision card */
    /* v3.4.5: final card handled by teacher-dashboard-clean */
    markS6Phase2();
