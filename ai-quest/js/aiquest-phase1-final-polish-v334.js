...
(function(){
  ...
  const VERSION = 'v3.3.4-teacher-dashboard-restore';
  ...
  function addFinalReadinessCard(){
    ...
    card.innerHTML = `
      <h3 style="margin:0 0 8px">Teacher Dashboard Role Separation</h3>
  ...
  function refresh(){
    normalizeRiskLabels();
    /* v3.3.4 safe restore: no extra teaching decision card */
    /* v3.3.4: final card handled by teacher-dashboard-clean */
    markS6Phase2();
