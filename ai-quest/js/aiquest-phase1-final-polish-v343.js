...
(function(){
  ...
  function addFinalReadinessCard(){
    ...
    card.innerHTML = `
      <h3 style="margin:0 0 8px">Teacher Individual Detail Fix</h3>
  ...
  function refresh(){
    normalizeRiskLabels();
    /* v3.4.3 safe restore: no extra teaching decision card */
    /* v3.4.3: final card handled by teacher-dashboard-clean */
    markS6Phase2();
