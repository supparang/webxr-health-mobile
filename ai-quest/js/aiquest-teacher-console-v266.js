/*
  CSAI2102 AI Quest
  PATCH v2.6.6 Teacher Console Session Switch
  ------------------------------------------------------------
...
(function(){
  ...
  const VERSION = 'v2.6.6-teacher-console-visual-clarity';
  ...
  function renderPhaseAnalytics(rows){
    ...
    const ordered = ['AI vs Automation','Agent Foundation','PEAS Gate','Environment Gate','Rationality Gate','Final Attack'];
  ...
  function buildCleanLink(mode){
    ...
    if(mode === 'teacher'){
      ...
      url.searchParams.set('v', '20260611-constructed266');
    }else{
      url.searchParams.set('v', '20260611-constructed266');
    }
