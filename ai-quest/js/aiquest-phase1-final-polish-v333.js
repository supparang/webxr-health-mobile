...
(function(){
  ...
  const VERSION = 'v3.3.3-teacher-dashboard-restore';
  ...
  function addFinalReadinessCard(){
    ...
    card.innerHTML = `
      <h3 style="margin:0 0 8px">Teacher Risk Wording Polish</h3>
  ...
  function refresh(){
    normalizeRiskLabels();
    /* v3.3.3 safe restore: no extra teaching decision card */
    /* v3.3.3: final card handled by teacher-dashboard-clean */
    markS6Phase2();
