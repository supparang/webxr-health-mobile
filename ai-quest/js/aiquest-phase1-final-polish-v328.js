...
(function(){
  ...
  const VERSION = 'v3.2.8-phase1-classroom-ready-final';
  ...
  function addFinalReadinessCard(){
    ...
    const host = document.querySelector('#phase1TeacherChecklistV328') ||
      document.querySelector('#phase1TeacherChecklistV327') ||
      Array.from(document.querySelectorAll('section, div, article')).find(el=>/Phase 1 Classroom Ready Checklist/i.test(text(el))) ||
      document.body;

    const card=document.createElement('div');
    card.id='phase1FinalReadinessCardV328';
    ...
    card.innerHTML = `
      <h3 style="margin:0 0 8px">Phase 1 Classroom Ready Final</h3>
