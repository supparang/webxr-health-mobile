...
(function(){
  ...
  function addTeacherChecklist(){
    ...
    const old=document.getElementById('phase1TeacherChecklistV329') || document.getElementById('phase1TeacherChecklistV328') || document.getElementById('phase1TeacherChecklistV327');
    if(old) old.remove();
    ...
    box.id='phase1TeacherChecklistV329';
