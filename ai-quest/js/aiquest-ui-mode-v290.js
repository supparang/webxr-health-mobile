/*
  CSAI2102 AI Quest
  PATCH v2.9.0 Student Mode Session 2 Feedback
  ------------------------------------------------------------
...
(function(){
  ...
  const VERSION = 'v2.9.0-student-mode-session5-astar';
  ...
  function ensureStudentStartPanel(){
    ...
    panel.innerHTML = `
      ...
      <p>
        <b>Session 1–5</b> เปิดตาม progress: AI Awakening → Agent Builder → Boss B1 → Search Maze → Route Cost
      </p>
  ...
  function refreshStudentProgressPanel(showToastFlag){
    ...
    if(s5.bestScore != null){
      overall = s5.mastered
        ? 'ผ่าน Session 5 แบบ Mastery แล้ว พร้อมต่อยอด Boss B2 เมื่อเปิด'
        : s5.bestScore >= 70
          ? 'ผ่าน Session 5 แล้ว สามารถเล่นซ้ำเพื่อ Mastery หรือรอ Boss B2 ได้'
