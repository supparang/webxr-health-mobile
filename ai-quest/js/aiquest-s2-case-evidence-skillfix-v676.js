/* CSAI2102 S2 Evidence Picker metadata repair v6.8.4
   Also backfills integrity guards and reflection Case usability helpers for cached shells.
*/
(()=>{'use strict';
  if(window.__AIQUEST_S2_CASE_EVIDENCE_SKILLFIX_V684__)return;
  window.__AIQUEST_S2_CASE_EVIDENCE_SKILLFIX_V684__=true;
  ...
  function patch(){
    ...
    if(!api||api.__caseEvidenceSkillFixV684||typeof api.buildDeck!=='function')return false;
    api.__caseEvidenceSkillFixV684=true;
  ...
  function rescue(){
    ...
    if(!window.__AIQUEST_REFLECTION_CASE_CARD_DETAIL_V677__)add('aiquestReflectionCaseCardDetailV677','./js/aiquest-reflection-case-card-detail-v677.js?v=20260707-casedetail677');
    if(!window.__AIQUEST_REFLECTION_SELECTED_CASE_BRIEF_V678__)add('aiquestReflectionSelectedCaseBriefV678','./js/aiquest-reflection-selected-case-brief-v678.js?v=20260707-casebrief678');
  }
