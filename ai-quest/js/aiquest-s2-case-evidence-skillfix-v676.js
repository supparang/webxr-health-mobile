/* CSAI2102 S2 Evidence Picker metadata repair v6.8.3
   Also backfills integrity guards and case-card prompt previews for cached player shells.
*/
(()=>{'use strict';
  if(window.__AIQUEST_S2_CASE_EVIDENCE_SKILLFIX_V683__)return;
  window.__AIQUEST_S2_CASE_EVIDENCE_SKILLFIX_V683__=true;
  ...
  function patch(){
    ...
    if(!api||api.__caseEvidenceSkillFixV683||typeof api.buildDeck!=='function')return false;
    api.__caseEvidenceSkillFixV683=true;
