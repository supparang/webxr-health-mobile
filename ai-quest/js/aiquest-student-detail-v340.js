/*
  CSAI2102 AI Quest
  PATCH v3.4.0 Student Detail Session 2
...
const VERSION = 'v3.4.0-student-detail-session2';
  ...
  function ensurePanel(){
    ...
    panel.innerHTML = `
      ...
      <div class="studentSearchRow">
        ...
        <select id="studentReview FocusFilter">
      ...
      <div class="teacherTableWrap">
        <table class="teacherTable">
          <thead><tr><th>Student</th><th>Section</th><th>Attempts</th><th>Best</th><th>Latest</th><th>Reflection</th><th>Review Focus</th><th>Detail</th></tr></thead>
    ...
    $('#studentReview FocusFilter').onchange = renderAllStudentsFromState;
  ...
  function renderAllStudentsFromState(){
    ...
    const filter = $('#studentReview FocusFilter')?.value || 'all';
    let list = all.slice();
