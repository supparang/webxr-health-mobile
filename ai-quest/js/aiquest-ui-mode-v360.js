/*
  CSAI2102 AI Quest
  PATCH v3.6.0 Student Mode Session 2 Feedback
  ------------------------------------------------------------
...
(function(){
  ...
  const VERSION = 'v3.6.0-student-mode-session6-kb';
          ...
          : id === 'm3'
            ...
            : id === 'm4'
              ...
              : id === 'm5'
                ...
                : id === 'm6'
                  ? 'เริ่มเล่น Session 6 หลังผ่าน Boss B2'
                  : 'เริ่มเล่นด่านถัดไป';
              ...
              : id === 'm3'
                ...
                : id === 'm4'
                  ...
                  : id === 'm5'
                    ...
                    : id === 'm6'
                      ? 'พร้อมต่อยอด S7 Logic Lab เมื่อเปิด'
  ...
  function refreshStudentProgressPanel(showToastFlag){
    ...
    if(b2.bestScore != null && s6.bestScore == null){
      overall = b2.mastered
        ? 'ผ่าน Boss B2 แบบ Mastery แล้ว พร้อมเริ่ม S6 Knowledge Base Forge'
        : b2.bestScore >= 70
          ? 'ผ่าน Boss B2 แล้ว สามารถเริ่ม S6 หรือเล่นซ้ำเพื่อ Mastery ได้'
          : 'จบ Boss B2 แล้ว แต่ควรทบทวน Search Arena เพิ่มก่อนขึ้น S6';
    }

    if(s6.bestScore != null){
      overall = s6.mastered
        ? 'ผ่าน S6 Knowledge Base Forge แบบ Mastery แล้ว พร้อมต่อยอด S7 Logic Lab เมื่อเปิด'
        : s6.bestScore >= 70
          ? 'ผ่าน S6 แล้ว เล่นซ้ำเพื่อ Mastery หรือรอ S7 ได้'
          : 'จบ S6 แล้ว แต่ควรทบทวน fact/rule/knowledge representation เพิ่ม';
    }
    ...
    box.innerHTML = `
      ...
      <div class="studentSessionStatusGrid">
        ...
        ${sessionCardHTML('Session 6: Knowledge Base Forge', s6)}
      </div>
    `;

    if(showToastFlag && window.showToast){
      showToast('อัปเดตสถานะ S1–S6 / B1–B2 แล้ว');
    }
  }
