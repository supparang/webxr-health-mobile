(function(){
  'use strict';
  const VERSION='v4.1.5-s6-retry-sync-loader';
  ...
  function loadS6(){if(isTeacher())return;load('aiquestS6AccessGateV412','./js/aiquest-s6-access-gate-v412.js?v=20260701-s6access412');load('aiquestS6ResultSyncV415','./js/aiquest-s6-result-sync-v415.js?v=20260701-s6sync415');}
  ...
  function refresh(){normalize();loadS6();}
