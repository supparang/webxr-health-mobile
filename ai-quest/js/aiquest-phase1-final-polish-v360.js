(function(){
  'use strict';
  const VERSION='v4.2.1-direct-cloud-loader';
  ...
  function loadStudentTools(){if(isTeacher())return;load('aiquestDirectCloudV421','./js/aiquest-direct-cloud-v421.js?v=20260701-cloud421');load('aiquestS6AccessGateV412','./js/aiquest-s6-access-gate-v412.js?v=20260701-s6access412');load('aiquestS6ResultSyncV415','./js/aiquest-s6-result-sync-v415.js?v=20260701-s6sync415');}
