...
(function(){
  ...
  const VERSION = 'v3.4.9-teacher-dashboard-restore';
  ...
  function addFinalReadinessCard(){
    ...
    card.innerHTML = `
      <h3 style="margin:0 0 8px">Teacher bySession Server Summary</h3>
  ...
  function refresh(){
    normalizeRiskLabels();
    /* v3.4.9 safe restore: no extra teaching decision card */
    /* v3.4.9: final card handled by teacher-dashboard-clean */
    markS6Phase2();
