/* UX Quest • Elite W1–B2 Stable Replay v4
   Stable replay upgrade: unique variants, balanced cards, and boss waves.
   Pressure Gate removed because it blocked mission start in the live classroom build. */
(()=>{'use strict';
...
const variants=[
 ...
 ['Mobile Constraint','ต้องทำงานบนมือถือขณะเดินทาง','พื้นที่หน้าจอและการพิมพ์ทำให้การค้นหาซ้ำมีต้นทุนสูง'],
...
function style(){if(document.getElementById('uxq-elite-card-style'))return;const s=document.createElement('style');s.id='uxq-elite-card-style';s.textContent='.uxq-option{min-height:132px!important;display:flex;flex-direction:column}.uxq-option b{font-size:.71rem!important;letter-spacing:.1em;text-transform:uppercase;color:var(--uxq-accent)!important}.uxq-option span{display:block;min-height:4.75em;max-height:4.75em;overflow:hidden;line-height:1.5!important}.uxq-options{align-items:stretch}';document.head.appendChild(s);}
const prior=Object.getOwnPropertyDescriptor(window,'UXQMissionEngine');let current;
Object.defineProperty(window,'UXQMissionEngine',{configurable:true,get(){return current||(prior&&prior.get?prior.get.call(window):undefined)},set(engine){if(prior&&prior.set){prior.set.call(window,engine);engine=prior.get?prior.get.call(window):engine;}if(!engine||typeof engine.init!=='function'){current=engine;return;}const init=engine.init.bind(engine);current=Object.freeze({...engine,init(config){style();return init(upgrade(config));}});}});
window.UXQEliteW1B2=Object.freeze({version:'v4-stable',upgrade});
})();