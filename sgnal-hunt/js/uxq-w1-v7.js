...
// V7 — Canonical Progress + Tutorial once + Strict 60-core Replay Scheduler + 720 Scenario Variants
...
(function () {
  ...
  const ROUND_SIZE = 5;
  const SESSION_KEY = 'uxquest-w1-session-v7';
  const PROGRESS_KEY = 'uxquest-w1-progress-v7';
  const LEGACY_KEYS = [
  ...
  function loadProgress() {
    ...
    const canonical = window.UXQProgressV7 && typeof window.UXQProgressV7.readW1 === 'function'
      ? window.UXQProgressV7.readW1()
      : null;
  ...
  function resetAllW1() {
    ...
    clearLegacyData();
    if (window.UXQProgressV7 && typeof window.UXQProgressV7.reset === 'function') {
      window.UXQProgressV7.reset();
    }
    render();
    scrollToTop();
  }
  ...
  function updateProgressFromRound(starCount) {
    ...
    if (window.UXQProgressV7 && typeof window.UXQProgressV7.writeW1 === 'function') {
      window.UXQProgressV7.writeW1({
      ...
      <section class="complete-card">
        ...
        <div class="completion-action-grid">
          ${state.mode === 'tutorial' && starCount >= 1 ? `
            <a class="completion-action next-week" href="./w2-design-thinking-sprint.html">
