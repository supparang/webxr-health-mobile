// === /sgnal-hunt/js/uxq-hub-v9.js ===
// UX Quest Mission Control • V9
// Reads one canonical W1 state only. W1 never loops Tutorial after a pass.

(function () {
  'use strict';

  const W1_DETAIL_KEY = 'uxquest-w1-progress-v9';
  const W1_SESSION_KEY = 'uxquest-w1-session-v9';
  ...
  function setW2Action(enabled, label) {
    ...
    if (enabled) {
      launch.href = './w2-design-thinking-sprint.html?v=20260623-w1-v9';
  ...
  function updateHub() {
    ...
    if (w2.active) {
      setCurrent({
        ...
        href: './w2-design-thinking-sprint.html?v=20260623-w1-v9&resume=1',
        cta: 'ทำ W2 ต่อ',
        state: 'resume'
      });
    } else if (w2.cleared) {
      setCurrent({
        ...
        href: './w2-design-thinking-sprint.html?v=20260623-w1-v9',
        cta: 'เล่น W2 ซ้ำ',
        state: 'complete'
      });
    } else if (w1.cleared) {
      ...
      setCurrent({
        ...
        href: './w1-ux-detective.html?resume=1&v=20260623-w1-v9',
        cta: 'ทำ W1 ต่อ',
        state: 'resume'
      });
    } else {
      setCurrent({
        ...
        href: './w1-ux-detective.html?mode=tutorial&v=20260623-w1-v9',
  ...
  function resetAct() {
    ...
    try {
      ...
      console.warn('[UXQ V9] Could not reset local progress.', error);
    }
