...
// V9 gate: canonical W1 unlock + direct W1 completion handoff + 30-core Replay + Transfer Challenge
...
(function () {
  ...
  const W1_PROGRESS_KEY = 'csai2601-uxquest-act1-v9';
  ...
  function acceptW1CompletionLink() {
    const bridge = window.UXQProgressV9;
    if (bridge && typeof bridge.applyW1CompletionFromUrl === 'function') {
      bridge.applyW1CompletionFromUrl();
    }
  }
  ...
  function isW1Unlocked() {
    ...
    if (bridge && typeof bridge.readW1 === 'function') {
      return Boolean(bridge.readW1().cleared);
    }
    ...
    stage.innerHTML = `
      <section class="sprint-mode-shell">
        ...
        ${unlocked ? `
          ...
          <div class="sprint-takeaway"><b>W2 Locked</b><span>ผ่าน W1 UX Detective อย่างน้อย 1★ ก่อนเริ่ม Design Thinking Sprint</span></div>
          <div class="sprint-actions"><a class="primary-btn" href="./w1-ux-detective.html">กลับไปผ่าน W1 →</a></div>`}
      </section>`;
    if (!unlocked) return;
  ...
  function lockedScreen() {
    stage.innerHTML = `<section class="sprint-mode-shell"><p class="eyebrow">ACCESS LOCKED</p><h2>ผ่าน W1 ก่อนเข้าสู่ W2</h2><p>Design Thinking Sprint เปิดเมื่อคุณผ่าน UX Detective อย่างน้อย 1★ เพื่อให้มีพื้นฐานเรื่อง User Goal และ UX Impact ก่อน</p><div class="sprint-actions"><a class="primary-btn" href="./w1-ux-detective.html">ไปผ่าน W1 UX Detective →</a></div></section>`;
  }
