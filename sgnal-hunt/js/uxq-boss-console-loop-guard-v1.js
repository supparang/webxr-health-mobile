/* UX Quest • Mission Integrity Preloader v1.7
 * Loads case-specific hardening, replay banks, anti-guess and result-integrity
 * layers before the mission engine starts.
 */
(() => {
  'use strict';
  ...
  if (route && document.readyState === 'loading') {
    ...
    const qaLab = qa ? '<script data-uxq-w2-qa src="./js/uxq-w2-qa-lab-v1.js?v=20260706-w2-qa-v1"></' + 'script>' : '';
    document.write(w2Hardening + replay + antiGuess + integrity + qaLab);
  }
})();
