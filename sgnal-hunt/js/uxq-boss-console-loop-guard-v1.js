/* UX Quest • Mission Integrity Preloader v2.0
 * Loads hardening, replay banks, result integrity and teacher-only acceptance
 * tools before the mission engine starts. Student routes remain unchanged.
 */
(() => {
  'use strict';
  ...
  if (route && document.readyState === 'loading') {
    ...
    const stageSuite = !w2 && qa ? '<script data-uxq-stage-acceptance-suite src="./js/uxq-stage-acceptance-suite-v1.js?v=20260704-stage-qa-v1"></' + 'script>' : '';
