/* CSAI2601 UX Quest • W1 Balanced Compact v9c
 * Scope: W1 only. Loaded after v8/v9.
 * Fix: do NOT hide .uxqFairText/.uxqFairLetter generated by choice-fairness guard.
...
(() => {
  ...
  function style(){
    ...
    st.textContent = `
      ...
      body .question .option span:not(.uxqFairLetter):not(.uxqFairText):not(.uxqFairSub), body .verify .option span:not(.uxqFairLetter):not(.uxqFairText):not(.uxqFairSub), body .question .option small, body .verify .option small, body .question .option p, body .verify .option p{display:none!important;}
      body .question .option .uxqFairText, body .verify .option .uxqFairText{display:block!important;color:#eef6ff!important;font-weight:900!important;line-height:1.32!important;overflow-wrap:anywhere!important;white-space:normal!important;}
      body .question .option .uxqFairLetter, body .verify .option .uxqFairLetter{display:inline-grid!important;place-items:center!important;width:max-content!important;min-width:1.85rem!important;height:1.45rem!important;margin:0 0 .45rem 0!important;}
      body .question .option .uxqFairSub, body .verify .option .uxqFairSub{display:block!important;color:#a9b9d9!important;font-size:.82rem!important;line-height:1.35!important;margin-top:.35rem!important;}
  ...
  function apply(){
    ...
    $$('.question .option,.verify .option').forEach(el=>{
      ...
      if(b){b.style.setProperty('font-size','.94rem','important');b.style.setProperty('line-height','1.28','important');b.style.setProperty('display','-webkit-box','important');b.style.setProperty('-webkit-line-clamp','3','important');b.style.setProperty('-webkit-box-orient','vertical','important');b.style.setProperty('overflow','hidden','important');}
