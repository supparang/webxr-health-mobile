export class Leaderboard {
  ...
  submit(mode,diff,score){ const list=this.load(mode,diff); list.push({score, at: Date.now()}); list.sort((a,b)=>b.score-a.score); this.save(mode,diff,list); return list.slice(0,10); }
}