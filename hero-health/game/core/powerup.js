...
export class PowerUpSystem{ constructor(){ this.timeScale=1; this.scoreBoost=0; this._shield=0; }
  ...
  tick(dt){} consumeShield(){ if(this._shield>0){ this._shield--; return true;} return false; } }