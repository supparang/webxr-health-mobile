...
async function ensureVRButton(){
  ...
  try{
    ...
    console.warn('[HHA] VRButton module not available.');
  }
  return VRB;
}
export class Engine{
  ...
  makeBillboard(text){
    ...
    ctx.font='96px serif'; ctx.textAlign='center'; ctx.textBaseline='middle'; ctx.fillStyle='#fff'; ctx.fillText(text, size/2, size/2+8);
