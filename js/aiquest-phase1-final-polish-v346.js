...
(function(){
  ...
  const VERSION = 'v3.4.6-teacher-dashboard-restore';
  ...
  function addFinalReadinessCard(){
    ...
    card.innerHTML = `
      <h3 style="margin:0 0 8px">Teacher Detail Final Polish</h3>
  ...
  function refresh(){
    normalizeRiskLabels();
    /* v3.4.6 safe restore: no extra teaching decision card */
    /* v3.4.6: final card handled by teacher-dashboard-clean */
    markS6Phase2();
