...
(function(){
  ...
  let $start,$pause,$end,$strip,$sum,$hudS,$hudT,$hudM,$sp;
  ...
  window.addEventListener('load',()=>{$start=g('start');$pause=g('pause');$end=g('end');$strip=g('strip');$sum=g('end-summary');$hudS=g('hud-score');$hudT=g('hud-time');$hudM=g('hud-mode');$sp=g('spawner');window.SB_UI={start,pause:pause,resume:resume,togglePause:toggle};setHUD();});
