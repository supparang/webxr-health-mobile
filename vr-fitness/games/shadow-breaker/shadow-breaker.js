// === VR Fitness — Shadow Breaker (Production v1) ===
...
const SB_GAME_VERSION = '1.0.0-prod';
...
function sbDownloadCsv(){
  ...
  try{
    ...
    const header=[
      ...
      'accuracy','maxCombo','fever','timeUsedSec','seed','research','createdAt'
    ];
