...
function analyticsTarget(gameId,configured){
 ...
 if(gameId==='balance-hold')return new URL('../fitness/balance-hold-classroom-analytics-v47.html',location.href);
 return configured;
}
window.HH.openNextGame=function(zoneId){
 ...
 shell.searchParams.set('shellVersion',RELEASE);shell.searchParams.set('analyticsMode','full-once');shell.searchParams.set('_',Date.now());
