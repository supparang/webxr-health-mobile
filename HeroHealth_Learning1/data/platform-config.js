window.HH_CONFIG = {
  platformVersion: "2026.07-CLASSROOM60-TOOTHBRUSH-FINGER-V19.3",
  appName: "HeroHealth Learning Platform",
  deploymentState: "QA_TOOTHBRUSH_FRONT_CAMERA_MIRROR_FIX",
  ...
  toothbrushContract: { mode: "classroom_coach", durationSec: 90, zones: 6, settingsVisible: false, progressionByCompletion: true, input: "index-finger-only", trackingProfile: "index-finger-marker-brush-lock-v19.3", cameraProfile: "480x360-24fps", inferenceInput: "320x240", coordinateMapping: "object-fit-cover-direct-x", stableFramesRequired: 3, timerPausesWhenTrackingLost: true, markerBrushSameCoordinate: true, touchFallbackEnabled: false, zonePositionAssist: false },
  teacherPin: "",
  routes: {
  ...
  missionProfiles: {
    CLASS_60: {
      ...
      description: "แต่ละกลุ่มเริ่มคนละฐาน ทุกเกมเล่นหนึ่งรอบ Handwash ต้องครบ 7 ท่าถูและ 5 ขั้นกระบวนการ ส่วน Toothbrush ตรวจปลายนิ้วชี้เป็นตัวควบคุมหลัก วงสีเขียวและหัวแปรงใช้พิกัดเดียวกัน พร้อมแก้การกลับด้านแนวนอนของกล้องหน้า ระบบหยุดเวลาและซ่อนทั้งวงกับแปรงทันทีเมื่อ Tracking หลุด ไม่มี Touch fallback ระหว่าง QA ไม่มีหน้าตั้งค่า คะแนนทักษะใช้เพื่อวิเคราะห์และไม่บังคับ Retry",
  ...
  zones: [
    {
      ...
      games: [
        ...
        { id:"toothbrush", title:"Toothbrush Finger Tracking AR", thai:"Toothbrush AR", url:"./toothbrush-classroom-finger-v19-3.html?v=20260728-finger-mirror-fix-v19-3", status:"qa-index-finger-marker-brush-lock-v19-3", requiredReturnContract:true, progressionByCompletion:true, settingsVisible:false },
