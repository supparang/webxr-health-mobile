window.HH_CONFIG = {
  platformVersion: "2026.07-CLASSROOM60-TOOTHBRUSH-FINGER-V18",
  appName: "HeroHealth Learning Platform",
  deploymentState: "QA_TOOTHBRUSH_FINGER_COVER_MAP",
  ...
  toothbrushContract: { mode: "classroom_coach", durationSec: 90, zones: 6, settingsVisible: false, progressionByCompletion: true, input: "index-finger-primary-touch-fallback", trackingProfile: "index-finger-cover-map-v18", cameraProfile: "480x360-24fps", inferenceInput: "256x192", coordinateMapping: "object-fit-cover-corrected", zonePositionAssist: false },
  teacherPin: "",
  routes: {
  ...
  missionProfiles: {
    CLASS_60: {
      ...
      description: "แต่ละกลุ่มเริ่มคนละฐาน ทุกเกมเล่นหนึ่งรอบ Handwash ต้องครบ 7 ท่าถูและ 5 ขั้นกระบวนการ ส่วน Toothbrush ตรวจปลายนิ้วชี้และชดเชยการครอปภาพกล้องแบบ object-fit cover เพื่อให้แปรงตรงกับนิ้วจริง ไม่มีการดึงแปรงไปหาโซนอัตโนมัติ Touch ใช้เฉพาะเมื่อกล้องมองไม่เห็นนิ้ว ไม่มีหน้าตั้งค่า คะแนนทักษะใช้เพื่อวิเคราะห์และไม่บังคับ Retry",
  ...
  zones: [
    {
      ...
      games: [
        ...
        { id:"toothbrush", title:"Toothbrush Finger Tracking AR", thai:"Toothbrush AR", url:"./toothbrush-classroom-finger-v18.html?v=20260728-finger-cover-v18", status:"qa-index-finger-cover-map-v18", requiredReturnContract:true, progressionByCompletion:true, settingsVisible:false },
