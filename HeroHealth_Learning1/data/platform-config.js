window.HH_CONFIG = {
  platformVersion: "2026.07-CLASSROOM60-TOOTHBRUSH-FINGER-EASY-V17",
  appName: "HeroHealth Learning Platform",
  deploymentState: "QA_TOOTHBRUSH_FINGER_EASY",
  ...
  toothbrushContract: { mode: "classroom_coach", durationSec: 90, zones: 6, settingsVisible: false, progressionByCompletion: true, input: "index-finger-primary-touch-fallback", trackingProfile: "index-finger-easy-control-v17", cameraProfile: "480x360-24fps", inferenceInput: "256x192", controlAssist: "calibrated-relative-zone-assist" },
  teacherPin: "",
  routes: {
  ...
  missionProfiles: {
    CLASS_60: {
      ...
      description: "แต่ละกลุ่มเริ่มคนละฐาน ทุกเกมเล่นหนึ่งรอบ Handwash ต้องครบ 7 ท่าถูและ 5 ขั้นกระบวนการ ส่วน Toothbrush ใช้ Detect ปลายนิ้วชี้เป็นการควบคุมหลัก พร้อมเทียบตำแหน่งอัตโนมัติ Adaptive Smoothing และ Zone Assist เพื่อควบคุมง่ายขึ้น Touch ใช้เฉพาะเมื่อกล้องมองไม่เห็นนิ้ว ไม่มีหน้าตั้งค่า คะแนนทักษะใช้เพื่อวิเคราะห์และไม่บังคับ Retry",
  ...
  zones: [
    {
      ...
      games: [
        ...
        { id:"toothbrush", title:"Toothbrush Finger Tracking AR", thai:"Toothbrush AR", url:"./toothbrush-classroom-finger-v17.html?v=20260728-finger-easy-v17", status:"qa-index-finger-easy-v17", requiredReturnContract:true, progressionByCompletion:true, settingsVisible:false },
