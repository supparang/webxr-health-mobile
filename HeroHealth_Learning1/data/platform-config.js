window.HH_CONFIG = {
  platformVersion: "2026.07-CLASSROOM60-TOOTHBRUSH-RECOVERY-V23",
  appName: "HeroHealth Learning Platform",
  deploymentState: "QA_TOOTHBRUSH_MOBILE_RECOVERY_WATCHDOG",
  ...
  toothbrushContract: {
    ...
    trackingProfile: "mobile-throttled-watchdog-v23",
    cameraProfile: "320x240-24fps",
    inferenceInput: "256x192-throttled",
    coordinateMapping: "video-rect-cover-mirrored",
    handDetectionConfidence: 0.24,
    handPresenceConfidence: 0.22,
    handTrackingConfidence: 0.22,
    detectIntervalMs: 72,
    timerPausesAfterLossMs: 850,
    pointerHidesAfterLossMs: 1500,
    detectorWatchdogNoAttemptMs: 1800,
    detectorWatchdogNoSuccessMs: 3200,
    detectorRecoveryCooldownMs: 2500,
    ...
    detectionScheduler: "throttled-setTimeout-independent-loop",
    architecture: "single-standalone-classroom-challenge-with-watchdog"
  },
  teacherPin: "",
  routes: {
  ...
  missionProfiles: {
    CLASS_60: {
      ...
      description: "แต่ละกลุ่มเริ่มคนละฐานและเล่นแต่ละเกมหนึ่งรอบ Toothbrush ใช้ Classroom Challenge โหมดเดียวสำหรับมือถือ ตรวจจากภาพ 256×192 ประมาณ 12–14 ครั้งต่อวินาทีเพื่อลดภาระเครื่อง วาดวงและแปรงทุกเฟรม และมี Recovery Watchdog สร้าง Detector ใหม่อัตโนมัติเมื่อ inference ไม่ตอบสนองหรือไม่พบมือเป็นเวลานาน โซนล่างขยายขึ้นเพื่อไม่ต้องวางมือชิดขอบกล้อง เล่นหนึ่งรอบถือว่าจบภารกิจโดยไม่บังคับ Retry ส่วน Coverage, Direction Accuracy, Tracking, Recovery Count, Detection FPS และ Render FPS เก็บเป็น Learning Analytics",
  ...
  zones: [
    {
      ...
      games: [
        ...
        { id:"toothbrush", title:"Toothbrush Classroom Challenge", thai:"Toothbrush Challenge", url:"./toothbrush-classroom-challenge-v23.html?v=20260728-recovery-v23", status:"qa-mobile-recovery-watchdog-v23", requiredReturnContract:true, progressionByCompletion:true, settingsVisible:false, oneRoundCompletes:true, retryRequired:false },
