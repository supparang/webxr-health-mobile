window.HH_CONFIG = {
  platformVersion: "2026.07-CLASSROOM60-HANDWASH-R42-TOOTHBRUSH-V27-STUDENT-RESULT-R4-JUMPDUCK-V43-BALANCE-RESULT-V36",
  appName: "HeroHealth Learning Platform",
  deploymentState: "QA_HANDWASH_LOADER_PREFLIGHT_R42_TOOTHBRUSH_NEUTRAL_ZONE_LABEL_R4_JUMPDUCK_NATIVE_FINISH_V43_BALANCE_PASSPORT_RESULT_V36",
  ...
  zones: [
    ...
    },
    {
      ...
      games: [
        { id:"jumpduck", title:"JumpDuck Dash AR", thai:"JumpDuck Dash", url:"../fitness/jumpduck-classroom-v26-ar.html?v=20260729-native-finish-v43", status:"classroom-core-direct-body-v4.3-native-finish-api-wall-clock", requiredReturnContract:true },
