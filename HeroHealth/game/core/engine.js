// === core/engine.js ===
// Minimal canvas helper (pointer-events:none) + FX popText ตรงตามที่โหมด DOM ใช้ได้
export class Engine {
  constructor() {
...
export const FX = {
  popText(txt, pos){
    try{
      ...
      requestAnimationFrame(()=>{ el.style.transform='translate(-50%,-120%) scale(1.4)'; el.style.opacity='0'; });
