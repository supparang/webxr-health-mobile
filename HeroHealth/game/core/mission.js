export class MissionSystem {
  ...
  start(mode){
    ...
    const pick=this._rand(cand); const tgt=this._rand(pick.target);
  ...
  describe(m){
    const map={
      ...
      target_hits:t=>`เก็บตรงหมวด ${t} ครั้ง`,
      no_wrong_group:_=>'ห้ามเก็บผิดหมวด',
      hold_ok_sec:t=>`อยู่โซนน้ำพอดี ${t}s`,
      no_overflow:_=>'ห้ามน้ำล้น',
