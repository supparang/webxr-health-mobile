...
// อัตราเกิดแบบ "seconds per spawn"
let spawnIntervalS = 0.70;   // Normal
let lifeS           = 1.60;  // อายุไอคอน
let _accum = 0;              // time accumulator สำหรับควบคุมอัตรา
...
export function setFever(on){ fever = !!on; }              // สำหรับ main (ยังไม่ได้ใช้ตรง ๆ)
...
export function update(dt, bus){
  ...
  // คุมอัตราเกิดแบบ time-accumulator (ชัดเจนกว่าเดิมมาก)
  _accum += dt;
...
/* ---- OPTIONAL: เพิ่ม create() เพื่อให้ main รุ่นเก่าเรียกได้ด้วย ---- */
