// === goodjunk.js — 3D Emoji Shatter (G10, in-frame/on-top, PC/Mobile/VR) ===
...
function makeTarget3D(isGood){
  ...
  // ใช้ helper จาก main.js เพื่อสุ่มตำแหน่ง "ในกรอบกล้อง" เสมอ
  const p = utils?.randInView?.(rand(-0.2, 0.6)) || {x:0,y:0,z:0};
