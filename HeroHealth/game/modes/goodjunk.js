// === modes/goodjunk.js — DOM-spawn icons + Fever hooks + Shield/Star ===
...
export function setFever(on){ fever = !!on; }              // called by main when combo rules satisfied
export function grantShield(n=1){ allowMiss += n|0; }      // called by main when using shield
