...
let state = { modeKey:'goodjunk', difficulty:'Normal', running:false, timeLeft:60, fever:false, ctx:{hits:0,miss:0} };
const DIFFS = {
...
const MODE_NAME_TH = {
  goodjunk: 'ดี vs ขยะ', groups: 'จาน 5 หมู่',
  hydration: 'สมดุลน้ำ', plate: 'จัดจานสุขภาพ'
};
...
function createItem(){
  ...
  b.style.zIndex='120';
  b.style.fontSize='clamp(40px, 5.8vw, 72px)';  // ไอคอนใหญ่
  b.style.minWidth='70px'; b.style.minHeight='70px';
