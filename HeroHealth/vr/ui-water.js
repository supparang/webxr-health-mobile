// === vr/ui-water.js — Water Gauge (DOM) + helpers ===
...
export function destroyWaterGauge(){ const el=document.getElementById('waterWrap'); if(el) try{el.remove();}catch{} }
...
export function zoneFrom(val){ return (val>=40&&val<=70)?'GREEN':(val>70?'HIGH':'LOW'); }

// Screen float score (ใช้ตำแหน่งพิกัดจอ x,y)
...
export default { ensureWaterGauge, destroyWaterGauge, setWaterGauge, floatScoreScreen, burstAtScreen, zoneFrom };