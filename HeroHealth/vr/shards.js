// เอฟเฟกต์ "แตกกระจาย" + คะแนนเด้ง ใช้กับ A-Frame ได้ทันที (ไม่อ้าง THREE ตอน import)
const MODE_PALETTES = {
...
export function burstAt(sceneEl, worldPos, opts={}){ if(!SHARDS.root) SHARDS.attach(sceneEl); if(opts&&opts.mode) SHARDS.setMode(opts.mode); SHARDS.burst(worldPos,opts); }
