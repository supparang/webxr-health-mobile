...
const STUDENT_ID = '529';
const RELEASE = '20260908-PRODUCTION-QA-529-R1';
...
await rosterRef.set({
  ...
  seededBy:'tools/herohealth-admin/seed-production-qa-529.mjs',
  build:RELEASE
},{merge:true});
...
console.log('   Login: 529');
console.log('   Name: Test Student 529');
