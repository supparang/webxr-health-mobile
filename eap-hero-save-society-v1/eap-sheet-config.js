...
/* Cache-safe bootstrap: stable authority v3 + presentation-only Recent Portfolio owner. */
(function(){
  'use strict';
  ...
  function boot(){
    ...
    load('./eap-authority-runtime-v3.js?v=20260812-single-sheet-authority-v3-restored-r1','single-authority-v3-restored-r1');
