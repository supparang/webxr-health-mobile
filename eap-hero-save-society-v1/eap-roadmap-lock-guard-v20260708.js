/* =========================================================
   ...
   - No compact map, no top overlay, no student diagnostic spam.
========================================================= */
(function(){
'use strict';

const VERSION='v20260708-EAP-ROADMAP-LOCK-GUARD-V5-CLOUD-VERIFIED';
const PACK='EAP_HERO_SESSION_CONTENT_PACK';
const STATE='EAP_HERO_PROGRESS_V3';
const PASS=60;
const SKILLS=['reading','listening','writing','speaking'];
const STYLE='eapUnifiedSeqLockStyleV5Cloud';
const TOAST='eapUnifiedSeqLockToastV5Cloud';
...
window.EAPRoadmapLockGuard={version:VERSION,cloudVerifiedOnly:true,routeStatus:routeStatus,isUnlocked:isUnlocked,reason:reason,refresh:decorate,maxOpenIndex:maxOpenIndex,firstIncompleteIndex:firstIncompleteIndex,currentRoute:currentRoute};
