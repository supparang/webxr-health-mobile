import { initializeApp } from "https://www.gstatic.com/firebasejs/11.6.1/firebase-app.js";
        ...
        // ==========================================
        // DATABASE: ระบบสุ่มคำถาม! แต่ละด่านมี 5 Variations ไม่ซ้ำกัน
        // ==========================================
        const missionDB = [
...
AI Mood ล่าสุด: ${sessionStats.lastAIMood}`;
        ...
        try {
            // รองรับทั้ง environment แบบ injected (__firebase_config)
            // และ GitHub Pages / static hosting ปกติผ่าน window.TECHPATH_FIREBASE_CONFIG
