// HUD แท่ง FEVER + เกราะ (ใช้ร่วมทุกโหมดได้)
(function (global) {
  'use strict';
  ...
  function injectCSS() {
    ...
    st.textContent = `
      ...
      #feverFill{
        height:100%;width:0%;transition:width .15s ease-out;
        background:linear-gradient(90deg,#37d67a,#06d6a0)
      }
      #shieldChip{
        position:fixed;right:16px;top:16px;background:#0f172acc;
      ...
      .fever-on{
        box-shadow:0 0 0 3px #ffd16655,0 0 22px #ffb703aa;
      }
    `;
