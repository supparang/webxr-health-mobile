...
// GoodJunk Coop Lobby
// FULL PATCH v20260331-COOP-LOBBY-COOPROOMS-FIX
...
// สำคัญ: ใช้ coopRooms ให้ตรงกับ Firebase Rules
...
function buildRunUrl(startAt, spectator = false) {
  ...
  return `./goodjunk-coop-run.html?v=20260331-cooprooms-fix&${q.toString()}`;
}
