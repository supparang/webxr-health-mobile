(function(){
  ...
  const LAUNCH_GAME_VERSION = qs.get('launchGameVersion') || 'groups-next';

  const RUN_PATH = './groups-run.html'; // เปลี่ยนภายหลังเมื่อมี run จริง
  ...
  function startGame(){
    ...
    url.searchParams.set('gameId', 'groups-next');
    ...
    console.log('[Groups Next] ready to launch:', url.toString());
  }
