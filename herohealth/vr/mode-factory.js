...
// PRODUCTION — FIX export + FIX TDZ + decorateTarget + hha:shoot
...
/**
 * boot(mount, seed, spawnRate, sizeRange, kinds, onHit, onExpire, decorateTarget)
 * - Emits no events itself; listens to hha:shoot to hit targets
 */
