...
(function(){
  ...
  function ensureLayer(){
    ...
    st.textContent = `
      .hha-popText{
        ...
        font-family:system-ui,-apple-system,Segoe UI,Roboto,Arial;font-weight:900;font-size:14px;line-height:1;
      ...
      .hha-spark{
        position:absolute;left:0;top:0;width:6px;height:6px;border-radius:999px;opacity:.9;
  ...
  const LIMIT = { maxNodes:120, maxSparks:22, popDurationMs:520, sparkDurationMs:420 };
