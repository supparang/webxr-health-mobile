...
(function(root){
  ...
  function exitStorm(){
    ...
    // deterministic in research: still uses seeded rng => deterministic
  ...
  function spawnBossDecoys(){
    // 1-2 decoy around boss for phase2
  ...
  function spawnOne(){
    ...
    // freeze => longer ttl feel (already via css; also slow spawns via adaptive tick)
