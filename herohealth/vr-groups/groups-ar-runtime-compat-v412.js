(() => {
  ...
  /*
   * Samsung Internet may expose DecompressionStream but still fail while
   * constructing/reading a gzip stream. Use the proven uncompressed runtime
   * on Samsung Internet and Android WebView instead of trusting API presence.
   */
  ...
  function loadLegacy(reason) {
    ...
    load(
      ...
      () => {
        ...
        console.info('[Groups AR Runtime]', PATCH, 'legacy', reason, ua);
      },
      renderLoadError
    );
  }
