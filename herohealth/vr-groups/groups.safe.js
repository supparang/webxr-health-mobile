...
✅ PATCH: targets now render emoji textContent + size/font tuned (centered)
*/
...
(function (root) {
  ...
  // ✅ PATCH: render emoji as textContent + tuned font-size
  Engine.prototype._spawnDomTarget = function (spec) {
    ...
    // keep attribute (debug/inspect)
    el.setAttribute('data-emoji', spec.emoji || '');

    // ✅ IMPORTANT: show emoji
    ...
    // font-size: scale gently with size
    try{
