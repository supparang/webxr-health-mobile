...
// ✅ Failure overlay shows tried paths + stack
  ...
  function showFail(err, tried){
    ...
    el.innerHTML = `
      <div style="max-width:900px;margin:0 auto">
        ...
        <div style="opacity:.8;margin-top:10px">Tip: ดูว่าใน HTML มี <code>#hydration-layer</code> หรือ <code>#hydration-layerL/R</code> จริงไหม</div>
      </div>
    `;
