...
// ✅ imports ./hydration.safe.js (module)
// ✅ shows REAL error stack for the first failing dependency
  ...
  function showFail(err, tried){
    ...
    el.innerHTML = `
      <div style="max-width:980px;margin:0 auto">
        ...
        <div style="margin:12px 0 6px 0;font-weight:700">REAL Error:</div>
        ...
        <div style="margin-top:12px;opacity:.9">
          Tip: ถ้าขึ้น 404 มักเป็นไฟล์ที่ hydration.safe.js import ไม่เจอ เช่น <code>../vr/ui-water.js</code> หรือ <code>../vr/ai-coach.js</code>
        </div>
      </div>
    `;
