...
html.hh-handwash-target-r38 #waterZone{
 right:auto!important;bottom:auto!important;left:50%!important;top:43%!important;
 ...
 background:rgba(9,37,53,.82)!important;box-shadow:0 0 0 7px rgba(255,226,123,.12),0 18px 45px rgba(0,0,0,.40)!important;
}
html.hh-handwash-target-r38 #waterZone{height:158px!important;min-height:158px!important;top:42%!important}
...
html.hh-handwash-target-r38 #waterZone::after{
 ...
 padding:7px 12px;border-radius:999px;background:rgba(4,21,33,.96);border:1px solid rgba(132,226,255,.42);
...
@media(max-height:700px){
 html.hh-handwash-target-r38 #soapZone,
 html.hh-handwash-target-r38 #towelZone,
 html.hh-handwash-target-r38 #waterZone{top:40%!important;width:124px!important;min-width:124px!important;height:104px!important;min-height:104px!important}
