(() => {
  ...
  const RELEASE = '20260731-HANDWASH-WHO-LOADER-R43.3-BASEURI-FIX';
  ...
  const showFailure = error => {
    console.error('[Handwash WHO Loader R43.3]', error);
  ...
  async function boot() {
    ...
    // document.baseURI respects the <base href="../herohealth/hygiene-zone/"> injected
    // by the classroom bootstrap. location.href points to HeroHealth_Learning1 and caused 404.
    ...
    console.info('[Handwash R43.3] loading WHO runtime from', loaderUrl.href);
    ...
    try {
      ...
      throw new Error(`WHO R43.3 loader syntax error: ${error.message}`);
    }

    console.info('[Handwash] WHO loader compatibility ready', RELEASE);
    new Function(`${loaderSource}\n//# sourceURL=handwash-who-v4-r43-3-runtime-loader.js`)();
