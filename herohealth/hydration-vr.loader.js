...
(function () {
  ...
  const v = q.get('v') || q.get('ts') || ''; // allow cache-bust via v or ts
  ...
  const candidates = [
    ...
    './hydration.safe.js',               // (B) page inside hydration-vr/
    ...
    el.innerHTML = `
      <div style="max-width:880px;margin:0 auto">
        ...
        <div style="margin-top:12px;opacity:.9">
          ✅ ทดสอบเร็ว: เปิดลิงก์ที่อยู่ใน "Tried paths" ทีละอันในเบราว์เซอร์ ถ้าเห็น 404 แปลว่า path/case ผิด หรือยังไม่ได้ deploy
        </div>
      </div>
    `;
