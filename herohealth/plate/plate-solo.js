/* === /herohealth/plate/plate-solo.js ===
   ...
   BASELINE extracted from tested platev1 solo
   PATCH v20260320-PLATE-SOLO-JS
*/
'use strict';
...
function endGame(reason) {
  ...
  setText('endSub', `mode=solo • diff=${S.ctx.diff} • view=${S.ctx.view} • phase=${friendlyPhaseLabel(S.phase)}`);
