...
// ✅ Boots SAFE engine from ./plate.safe.js
// ✅ Wires HUD listeners (hha:score, hha:time, quest:update, hha:coach, hha:end)
// ✅ End overlay uses aria-hidden only (CSS handles show/hide)
// ✅ Back HUB + Restart
...
function getViewAuto() {
  // allow explicit query force (for experiments) but no UI menu override
...
function buildEngineConfig() {
  ...
  // ✅ default 90s for PlateVR, but allow override by ?time=
