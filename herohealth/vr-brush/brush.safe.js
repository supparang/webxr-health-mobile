...
// PATCH v20260303c-BRUSH-ABC-AI-FULL-FIX
// ✅ Stage A/B/C
// ✅ Evidence 3 types (B)
// ✅ Quiz Analyze (C)
...
// ✅ FIX#1: S.hits++ (accuracy/risk correct)
// ✅ FIX#2: whiff uses onMiss('whiff') (consistent penalties)
(function(){
  'use strict';
  ...
  function handleHit(t, x, y, source){
    ...
    // ✅ FIX#1: count hit here (accuracy correct)
    S.hits += 1;
  ...
  function onShoot(ev){
    ...
    // ✅ FIX#2: whiff uses onMiss() for consistent penalty + streak
    onMiss('whiff');
