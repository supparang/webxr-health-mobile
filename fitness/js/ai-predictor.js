...
// ES Module — exports AIPredictor + also sets window.RB_AI for compatibility
'use strict';
...
function predictFromSnapshot(s) {
  ...
  else if (hp < 0.45) tip = 'ระวัง HP—อย่ากดรัว ให้กดเฉพาะเป้าที่ใกล้เส้น';
...
// Also expose global bridge (optional)
try {
