// === js/engine.js — Shadow Breaker core (2025-11-22 SAFE + FX) ===
'use strict';
...
class ShadowBreakerGame {
  ...
  wireUI() {
    ...
    /* ป้องกัน spacebar scroll ตอนเล่น */
  ...
  advanceBoss(){
    this.bossIndex++;
    // ชนะบอส 1 ตัว เติม HP ผู้เล่นเล็กน้อย
  ...
  spawnTarget(){
    ...
    // ให้หน้าบอสมาเป็น emoji เป้าบางครั้ง (เฉพาะ good)