...
// PATCH v20260412a-SB-ENGINE-CLEAN-READY

'use strict';

const SB_ENGINE_VERSION = 'v20260412a-SB-ENGINE-CLEAN-READY';
...
async function runRound(engine, round) {
  ...
  if (round.type === 'boss') {
    ...
    state.boss.hpMax = actions.length;
    state.boss.hp = actions.length;
  } else {
