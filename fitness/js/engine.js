// === Shadow Breaker — engine.js (2025-11-20 Production C + DomRenderer) ===
'use strict';
...
// registerTouch ถูกเรียกจาก DomRenderer เวลา pointerdown บนเป้า
function registerTouch(x, y, targetId){
  if (!game.running) return;
...
export function initShadowBreaker(){
  ...
  // สร้าง DomRenderer ผูกกับ #target-layer
