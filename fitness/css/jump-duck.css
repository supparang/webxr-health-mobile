/* === /fitness/css/jump-duck.css — Jump-Duck Rush UI (Boss+Actionbar) v20260208a === */
...
.jd-subtitle{ margin:0 0 12px; font-size:0.95rem; color:var(--jd-muted); }
.jd-section-title{ margin:0 0 12px; font-size:1.3rem; }
.jd-note{ margin:10px 0 12px; font-size:0.85rem; color:var(--jd-muted); }
...
.jd-menu-block{ margin-bottom:10px; }
.jd-hint{ font-size:0.8rem; color:var(--jd-muted); margin:6px 0 0; }
...
.jd-research-hint{ margin:4px 0 0; font-size:0.8rem; color:var(--jd-muted); }
...
.jd-howto-list li{ margin-bottom:4px; }
.jd-howto-inline{ margin:8px 0 0; font-size:0.85rem; color:var(--jd-muted); }
...
.jd-btn-primary:hover{ filter:brightness(1.05); }

.jd-btn-sub{
  border-color:#1f2937;
  background:linear-gradient(90deg,#0f172a,#020617);
}
.jd-btn-sub:hover{ filter:brightness(1.06); }
...
.jd-hud-row{ display:flex; align-items:center; gap:6px; font-size:0.85rem; }
.jd-tag{
  font-size:0.75rem;
...
/* Play Top (Boss + progress) */
.jd-play-top{ margin-bottom:10px; }
...
.jd-bossbar-fill{
  ...
  transform:scaleX(0);
  background:linear-gradient(90deg,#fb7185,#facc15,#22c55e,#38bdf8);
}
.jd-bossbar-bottom{
  margin-top:8px;
  display:flex;
...
.jd-prog-text{ font-variant-numeric:tabular-nums; }
.jd-prog-time{ font-variant-numeric:tabular-nums; }
...
.jd-avatar.duck{ transform:translateY(16px) scaleY(0.88); }

/* Obstacles */
.jd-obstacles{ position:absolute; inset:0; z-index:2; pointer-events:none; }
.jd-obstacle{
  position:absolute;
  left:100%;
  bottom:0;
...
/* Actionbar (แก้ “กดไม่ได้” ให้ชัด ๆ) */
.jd-actionbar{
  display:flex;
  gap:10px;
  margin-top:10px;
...
.jd-act:active{ transform:translateY(1px); }
.jd-act-jump{
  background:linear-gradient(90deg,rgba(34,197,94,.95),rgba(34,197,94,.35));
  color:#04140a;
}
.jd-act-duck{
  background:linear-gradient(90deg,rgba(56,189,248,.95),rgba(56,189,248,.35));
  color:#001019;
}
...
.jd-result-row span{ color:var(--jd-muted); }
.jd-result-row b{ font-variant-numeric:tabular-nums; }

/* Shake */
.jd-field.jd-hit{ animation:jd-hit-pulse 0.25s ease-out; }
.jd-field.jd-miss{ animation:jd-miss-shake 0.35s ease-out; }
.jd-play-area.shake{ animation:jd-miss-shake 0.35s ease-out; }
