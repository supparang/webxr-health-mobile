(function(){
  "use strict";
  const ENGINE_URL="./word-match-snap-v4.js?v=20260804-open17-engine";
  const CONTROLLER_URL="./word-match-smooth-open-v17.js?v=20260804-open17";
  ...
  fetch(ENGINE_URL,{cache:"no-store"})
    ...
    .then(source=>{
      ...
      (0,eval)(`${patched}\n//# sourceURL=word-match-snap-v4-exported.js`);
      loadController();
    })
    .catch(error=>{
      console.error("Word Match engine loader V17",error);
      const root=document.getElementById("memoryRoot");
