(function(){
'use strict';
const VERSION='2026-08-09-CANONICAL-FIVE-GAME-ROUTES-V4-REAL-DURATION';
const ROUTES={
...
function openStage(stage){
  ...
  if(stage==='bonus_lens'){
    const query=carryView(new URLSearchParams({from:'passport',authority:'firebase',pid:identity.playerId,nickname:identity.nickname||identity.fullName||'Player',stage:'bonus_lens',v:'20260809-route4-real-duration'}));
  ...
  const query=carryView(new URLSearchParams({stage,run:'1',v:'20260809-route4-real-duration'}));
