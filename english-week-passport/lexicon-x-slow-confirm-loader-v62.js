(function(){
  ...
  if(badge)badge.innerHTML='<span class="test-badge">STANDALONE TEST</span> • V7.3 Last-Card Rescue';
  ...
  load("./lexicon-x-v7-core.js?v=20260805-v73",function(){load("./lexicon-x-v7-navigation.js?v=20260805-v73");});
}());
