(function(){
  ...
  if(badge)badge.innerHTML='<span class="test-badge">STANDALONE TEST</span> • V7.2 Repeat Swipe Fix';
  ...
  load("./lexicon-x-v7-core.js?v=20260805-v72",function(){load("./lexicon-x-v7-navigation.js?v=20260805-v72");});
}());
