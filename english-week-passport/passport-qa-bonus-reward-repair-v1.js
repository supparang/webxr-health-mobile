(()=>{
'use strict';
const VERSION='2026-08-14-QA-BONUS-REWARD-REPAIR-V1';
...
async function repair(){
  ...
  try{
    ...
    const sessionId=clean(auth?.progress?.attendanceSessionId||auth?.progress?.sessionId);
    ...
    if(existing.exists){lastPlayer=playerId;return true;}
    await ref.set({
