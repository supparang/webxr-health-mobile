...
const VERSION='2026-08-11-LEXICON-LENS-HUNT-RESTORED-R4';
...
function goPassport(){stopCamera();const q=new URLSearchParams({resume:'passport',fromGame:STAGE_ID,v:'20260811-lens-restored-r4'});if(savedReceipt)q.set('receipt',savedReceipt);location.replace('./index.html?'+q.toString())}
